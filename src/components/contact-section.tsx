            ...
            <div className="flex gap-4" style={{ marginTop: "20px" }}>
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-3 bg-white dark:bg-gray-800 rounded-full shadow-sm text-blue-900 dark:text-blue-100 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 transition-colors"
